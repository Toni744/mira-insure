...
No AI / ML is used in this version by design.
The system is deterministic, explainable, and production-ready. AI can be layered on later without re-architecture.
...
Designed for B2B / multi-tenant use
...
Client / Insurer System
  ...
  Decision Engine
        |
  DynamoDB (results & audit)

API Overview
POST /v1/claims/triage

Runs triage on a claim and returns a routing decision.
...
fraud_review	SIU / fraud investigation
Project Structure
claims-triage/
├── app/
